...
//     // Initialize selectedItems inside initState after orderController is initialized
//     if (orderController.selectedItems.isEmpty) {
//       orderController.selectedItems
//           .addAll(List<bool>.filled(orderController.cart.length, false));
//     }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('My Cart T-shirt',  style: TextStyle(color: Colors.white),),
